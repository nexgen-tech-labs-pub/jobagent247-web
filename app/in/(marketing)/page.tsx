        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-lg leading-relaxed mb-8" style={{ color: '#CBD5E1' }}>
              India&apos;s AI job search platform. Build a stronger resume, get matched with Naukri and LinkedIn roles,
              generate tailored cover letters, and prepare for interviews — all in one place.
            </p>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
            <div className="rounded-3xl p-6"
              ...
              <div className="space-y-2 mb-4">
                {[{ label: 'Senior Software Engineer · Infosys', score: 92, color: '#22C55E' }, { label: 'Data Scientist · TCS', score: 87, color: '#22C55E' }, { label: 'Cloud Architect · Wipro', score: 84, color: '#06B6D4' }].map((job) => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4"
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: '#CBD5E1' }}>Free plan available · Premium from ₹500/month</p>
          </div>
          <div className="flex flex-wrap gap-2">
          ...
          <div className="flex">
            ...
            <div className="flex-1 p-6">
              ...
              <div className="space-y-2">
                {[{ text: 'Tailor resume for Senior Software Engineer — Infosys', tag: 'High priority' }, { text: 'Prepare for Data Scientist interview (28 May)', tag: 'Upcoming' }, { text: 'Follow up with recruiter — TCS Digital', tag: 'Overdue' }].map((action) => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <Image
            ...
            width={308}
            height={120}
            className="logo-dark h-24 w-auto"
          />
          <Image
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 pt-4 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <span className="text-xs" style={{ color: '#334155' }}>Serving job seekers across India</span>
        </div>
      </div>
    </footer>
  )
